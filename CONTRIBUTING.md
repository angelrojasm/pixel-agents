...
```bash
git clone https://github.com/angelrojasm/pixel-agents.git
cd pixel-agents
npm install
...
[Open a bug report](https://github.com/angelrojasm/pixel-agents/issues/new?template=bug_report.yml) — the form will guide you through providing the details we need.

## Feature Requests

Have an idea? [Open a feature request](https://github.com/angelrojasm/pixel-agents/issues/new?template=feature_request.yml) — the form will guide you through describing the problem and your proposed solution. You can also browse and join ongoing conversations in [Discussions](https://github.com/angelrojasm/pixel-agents/discussions).
